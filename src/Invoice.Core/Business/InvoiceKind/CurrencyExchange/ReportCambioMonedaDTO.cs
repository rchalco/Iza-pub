...
namespace Invoice.Core.Business.InvoiceKind.CurrencyExchange
{
    ...
    /// </summary>
    public class ReportCambioMonedaDTO
    {
        ...
        /// 
        public List<CambioMonedaDetalleDTO> detalle { get; set; } = new List<CambioMonedaDetalleDTO>();
    }

    public class CambioMonedaDetalleDTO
    {
