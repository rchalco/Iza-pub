...
{
    public class RequestCambioMoneda : IFacturable
    {
        ...
        public List<RequestCambioMonedaDetalle> detalle { get; set; } = new List<RequestCambioMonedaDetalle>();
    }

    public class RequestCambioMonedaDetalle
    {
