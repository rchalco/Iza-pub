...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=155.138.212.216;Initial Catalog=DBPubIZA;Persist Security Info=True;User ID=sa;Password=m1k1ches*123;Pooling=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Command Timeout=0");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCaja).HasName("PK__tCajas__8BC79B34F8BFDDFC");

            entity.ToTable("tCajas", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdOperacionDiariaCaja).HasName("PK__tOperaci__9694AACDCFA4F66C");

            entity.ToTable("tOperacionDiariaCaja", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdPersona).HasName("PK__tPersona__A47881415C6F1104");

            entity.ToTable("tPersonas", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__tRoles__3C872F766B8F66F0");

            entity.ToTable("tRoles", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdrolMenu).HasName("PK__tRolesMe__E7658ACBC8686328");

            entity.ToTable("tRolesMenu", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdSesion).HasName("PK__tSesione__DB6C2DE6D3AEBDDD");

            entity.ToTable("tSesiones", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__tUsuario__645723A66C3D9D1F");

            entity.ToTable("tUsuarios", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdVersion).HasName("PK__tVersion__BBD5F8B2A1B47553");

            entity.ToTable("tVersiones", "shFabula");
        ...
        {
            entity.HasKey(e => e.IdMenuOpcion).HasName("PK__tmenuOpc__0C9FFA5437914716");

            entity.ToTable("tmenuOpciones", "shFabula");
